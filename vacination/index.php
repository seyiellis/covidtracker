...
<p class="text-center"> Vacination Report</p>
      <hr />

      <form method="POST" action="detail.php">
        <div class="form-group col text-center">
          <label for="category">First Dose</label>
         <input class="form-check-input" type="radio" name="dose" id="firstDose" value="firstDose" checked>

          <label for="category">Second Dose</label>
         <input class="form-check-input mt-2" type="radio" name="dose" id="secondDose" value="secondDose">
        </div>
        <div class="form-group col text-center">
